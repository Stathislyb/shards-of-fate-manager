...
<script>
    export default {
        data() {
            ...
            if (this.$store.state.pages.chapter_create) 
            {
                state = this.$store.state.pages.chapter_create;
            }
        ...
        watch: {
            formValidate: {
                ...
                handler(value) 
                {
                    this.$store.commit('pages/chapter_create/setFormValidate', value);
                }
            }
        },
        methods: {
            ajax() {
                ...
                return {
                    create(data) {
                        ...
                        window.axios.post( process.env.MIX_BASE_RELATIVE_URL_BACKEND+'/trident/resource/Chapter',  form_data ).then((response) => {
