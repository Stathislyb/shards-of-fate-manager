...
<script>
    export default {
        data() {
            ...
            if (this.$store.state.pages.player_update) 
            {
                state = this.$store.state.pages.player_update;
            }
        ...
        watch: {
            formValidate: {
                ...
                handler(value) 
                {
                    this.$store.commit('pages/player_update/setFormValidate', value);
                }
            }
        },
        methods: {
            ajax() {
                ...
                return {
                    ...
                    update(id,data) {
                        ...
                        window.axios.post( process.env.MIX_BASE_RELATIVE_URL_BACKEND+'/trident/resource/Player/'+id,  form_data ).then((response) => {
