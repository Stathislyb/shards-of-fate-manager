...
<script>
    export default {
        data() {
            ...
            if (this.$store.state.pages.character_update) 
            {
                state = this.$store.state.pages.character_update;
            }
        ...
        watch: {
            formValidate: {
                ...
                handler(value) 
                {
                    this.$store.commit('pages/character_update/setFormValidate', value);
                }
            }
        },
        methods: {
            ajax() {
                ...
                return {
                    ...
                    update(id,data) {
                        ...
                        window.axios.post( process.env.MIX_BASE_RELATIVE_URL_BACKEND+'/trident/resource/Character/'+id,  form_data ).then((response) => {
